...
output <- rstan::sampling(lubricant_bearing_failures_model1, data = lubricant_bearing_fail_list, chains = 4, iter = 4000, control = list(adapt_delta = 0.9))
