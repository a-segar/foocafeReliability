...
## Basic stan model no suspensions
...
posterior_sample_params <- data.frame(lambda = stan_model_output_vals$lambda,
                     lambda = stan_model_output_vals$lambda + 1)
...
for (jj in 1:NROW(r_b)) {
  ...
  thisParams <- params[jj,]
  this_dist_fun <- get_dist_fun("poisson", thisParams)
